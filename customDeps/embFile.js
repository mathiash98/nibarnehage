...
const doc2pdf = require('./doc2pdf.js');
		...
		if(!options.mongoose || conn.readyState == 1){
		    ...
		    console.log('File [' + fieldname + ']: filename: ' + filename + ', encoding: ' + encoding + ', mimetype: ' + mimetype);
				if (mimetype == 'application/pdf') {
					...
					.on('end', function () {
						console.log('Done getting file from client.');
						doc2pdf(buff, filename, mimetype, function (err, pdf) {
							console.log('Got response from doc2pdf');
